...
class RecipeListTest {
    ...
    void testSortRecipesByDate() {
        Recipe recipe1 = new Recipe("Test Recipe", "Test Instructions", new Date(2000, 1, 1));
        Recipe recipe2 = new Recipe("Test Recipe 2", "Test Instructions 2", new Date(2023, 3, 1));
        Recipe recipe3 = new Recipe("Test Recipe 3", "Test Instructions 3", new Date(2023, 3, 2));
    ...
    void testUpdateDatabase() throws IOException {
        ...
        assertEquals("2023-04-02T00:00:00-07:00", jsonRecipe3.getString("dateCreated"));
    }
