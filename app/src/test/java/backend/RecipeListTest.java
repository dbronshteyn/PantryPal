...
// @Test
// void testAddRecipe() {
// Recipe recipe = new Recipe("", "Test Recipe", "Test Instructions", new
// Date());
...
// recipeList.getRecipes().add(new Recipe("id 1", "Test Recipe", "Test
// Instructions", new Date()));
// recipeList.getRecipes().add(new Recipe("id 2", "Test Recipe 2", "Test
// Instructions 2", new Date()));
// recipeList.getRecipes().add(new Recipe("id 3", "Test Recipe 3", "Test
// Instructions 3", new Date()));
...
// Recipe recipe1 = new Recipe("id 1", "Test Recipe", "Test Instructions", new
// Date());
// Recipe recipe2 = new Recipe("id 2", "Test Recipe 2", "Test Instructions 2",
// new Date());
// Recipe recipe3 = new Recipe("id 3", "Test Recipe 3", "Test Instructions 3",
// new Date());
...
// Recipe recipe1 = new Recipe("", "Test Recipe", "Test Instructions", new
// Date(currentTime - 1000));
// Recipe recipe2 = new Recipe("", "Test Recipe 2", "Test Instructions 2", new
// Date(currentTime));
// Recipe recipe3 = new Recipe("", "Test Recipe 3", "Test Instructions 3", new
// Date(currentTime + 1000));
...
// long currentTime = System.currentTimeMillis();
// Recipe recipe1 = new Recipe("id 1", "Test Recipe", "Test Instructions", new
// Date(currentTime - 1000)); // oldest
// Recipe recipe2 = new Recipe("id 2 ", "Test Recipe 2", "Test Instructions 2",
// new Date(currentTime)); // middle
// Recipe recipe3 = new Recipe("id 3", "Test Recipe 3", "Test Instructions 3",
// new Date(currentTime + 1000)); // newest
...
// String content = new
// String(Files.readAllBytes(Paths.get(this.databaseFile.getAbsolutePath())));
...
// String dateCreated = new
// SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX").format(new Date(currentTime +
// 1000));
...
// fw.write(
// "[{\"instructions\":\"Test
// Instructions\",\"dateCreated\":\"2023-11-11T00:55:14-08:00\",\"title\":\"Test
// Recipe\",\"recipeID\":\"id 1\"},{\"instructions\":\"Test Instructions
// 2\",\"dateCreated\":\"2023-11-11T00:55:15-08:00\",\"title\":\"Test Recipe
// 2\",\"recipeID\":\"id 2 \"},{\"instructions\":\"Test Instructions
// 3\",\"dateCreated\":\"2023-11-11T00:55:16-08:00\",\"title\":\"Test Recipe
// 3\",\"recipeID\":\"id 3\"}]");
// fw.flush();
// fw.close();
...
// assertEquals("Test Instructions 2",
// recipeList.getRecipes().get(1).getInstructions());
// assertEquals("id 3", recipeList.getRecipes().get(2).getRecipeID());
// String dateString =
// recipeList.getRecipes().get(2).getDateCreated().toString();

// // depends on the timezone you run the code from
// assertTrue(
// dateString.equals("Sat Nov 11 00:55:16 PST 2023") || dateString.equals("Sat
// Nov 11 08:55:16 UTC 2023"));
// }
